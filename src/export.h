...
void ExportToBlender(ProkaryoteBodyContainer assembly, string export_path, string file_name, int dimensions = 1024, int r_color = 180, int g_color = 180, int b_color = 180);
